...
static float Height_Bar(unsigned long pressure_LSB){
...
static unsigned char LLA_to_NED(signed long Latitude, signed long Longitude, float Height, float Position_NED[3]){
...
static void USART_Transmit(char* Message, unsigned char length){
