...
static unsigned char Write_Display(unsigned char Data_Byte){
...
static unsigned char Write_Display_Double(unsigned char Address_Byte, unsigned char Data_Byte){
...
static unsigned char Write_Character(char Character_to_write){
	...
	if (TWI_status != 4){return 0;}
	return 1;
}

static unsigned char Clear_Display(){
